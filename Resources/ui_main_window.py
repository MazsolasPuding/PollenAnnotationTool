...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.actionOpen_Drive_Dir = QAction(MainWindow)
        self.actionOpen_Drive_Dir.setObjectName(u"actionOpen_Drive_Dir")
        icon12 = QIcon()
        icon12.addFile(u":/Icons/drive.png", QSize(), QIcon.Normal, QIcon.Off)
        self.actionOpen_Drive_Dir.setIcon(icon12)
...
"}")
        ...
        self.toolBar.addAction(self.actionOpen_Drive_Dir)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionOpen_Drive_Dir.setText(QCoreApplication.translate("MainWindow", u"Open Drive Dir", None))
